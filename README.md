...
This is the Home Office Correspondence Service (HOCS) notify service. It sends emails to users based on system events.
...
If you are using an IDE, such as IntelliJ, this service can be started by running the ```HocsNotifyServiceApplication``` main class.
